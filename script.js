...
(_a = document.getElementById('resumeForm')) === null || _a === void 0 ? void 0 : _a.addEventListener('submit', function (event) {
    ...
    if (profilePictureInput && nameElement && emailElement && phoneElement && addressElement && educationElement && experienceElement && skillsElement) {
        ...
        if (resumeOutputElement) {
            ...
            buttonsContainer_1.id = "buttoncontainer";
            resumeOutputElement.appendChild(buttonsContainer_1);
            ...
            var sharelinkButton_1 = document.createElement("button");
            sharelinkButton_1.textContent = "copy shareable link";
            sharelinkButton_1.addEventListener("click", function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [3 /*break*/, 3];
                        case 3:
                            buttonsContainer_1.appendChild(sharelinkButton_1);
                            return [2 /*return*/];
                    }
                });
            }); }, {
                console: console,
                : .error("Resume output container not found")
            });
        }
        else {
